...
abstract class MovieRepository {
  Future<Either<Failure, List<Unit>>> addToWatchList(AddDetetToWatchListParams params);
  Future<Either<Failure, MoviesEntity>> getWitchListMovies(int page,AddDetetToWatchListParams params);
